...
// The boss is deliberately absent: its art is 119x87 and its five colliders do not tile it, so
// measuring a boss part against one circle reports a gap that is real but is phase 07's to close,
// not a drawing error. It is written up in 06-boss-presentation.md instead.
const AIMED_AT = ['enemy-', 'structure-'];
