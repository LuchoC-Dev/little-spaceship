...
content and made CI fail when they disagree. **11e is next** — level 1 redesigned onto the shapes 11c
built — and it inherits two concrete warnings. From 11b: `LifetimeSystem`'s safety box sits 128 units
